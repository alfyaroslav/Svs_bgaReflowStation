...
class UTFT
{
	public:
		...
		void	InitLCD(byte orientation=LANDSCAPE, SPIClass &wspi = SPI);
		void	clrScr();
...
*/
		...
		_current_font	cfont;
		_current_font	altfont;
		boolean			_transparent, setaltfont = false;
		boolean			nextaltfont = false;
