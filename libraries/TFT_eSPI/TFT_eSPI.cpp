...
{
  if (uniCode >1000){
		uniCode = uniCode - 1040+96+32+32;
		  if (font==1) {
			uniCode = uniCode+32;
			if (uniCode >255){uniCode = 32;}
		  }
  } //TEST
  ...
  if ((font==1) && ((uniCode < 32) || (uniCode > 127))) return 0; //TEST
  if ((font>2) && (font<9) && ((uniCode < 32) || (uniCode > 127))) return 0; //TEST
